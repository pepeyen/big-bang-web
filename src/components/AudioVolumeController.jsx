...
const AudioVolumeControler = (props) => {
    ...
    useEffect(() => {
        ...
        const volumeButtonIndicators = volumeButton.children;

        if(props.currentVolume >= 0.6){
            volumeButtonIndicators[1].style.fill = '#DADADA';
            volumeButtonIndicators[2].style.fill = '#DADADA';
        }else{
            volumeButtonIndicators[1].style.fill = '#DADADA';
            volumeButtonIndicators[2].style.fill = 'none';
        }
    },[props.currentVolume]);
        ...
        <div className="player-controller__volume">
            ...
            >
                <div
                    ...
                    style={{width: `${props.currentVolume * 100}%`}}
                />
            </div>
        </div>
    );
