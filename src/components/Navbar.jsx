            ...
            <div className="navbar__buttons">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <path
                                d="M17.9375 0.125C20.0469 0.125 21.7344 0.78125 23 2C24.2188 3.21875 24.875 4.90625 24.875 7.0625C24.875 8.42188 24.4062 9.78125 23.5625 11.1875C23 12.0312 22.3906 12.8281 21.6875 13.4844L13.7188 21.4062C13.3438 21.7344 12.9688 21.875 12.5 21.875C12.0312 21.875 11.6094 21.7344 11.2812 21.4062L3.3125 13.4844C2.70312 12.9219 2.14062 12.2656 1.625 11.4688C0.59375 9.96875 0.125 8.51562 0.125 7.0625C0.125 4.90625 0.734375 3.21875 2 2C3.21875 0.78125 4.90625 0.125 7.0625 0.125C8.79688 0.125 10.625 1.01562 12.5 2.70312C14.375 1.01562 16.1562 0.125 17.9375 0.125ZM20.6094 12.4531C21.4062 11.7031 22.0625 10.8594 22.5312 9.96875C23.0938 8.9375 23.375 8 23.375 7.0625C23.375 5.375 22.8594 4.01562 21.9219 3.07812C20.9844 2.14062 19.625 1.625 17.9375 1.625C16.9062 1.625 15.875 2.04688 14.75 2.79688C14.0938 3.26562 13.3906 3.875 12.6406 4.625L12.5 4.76562C11.5625 3.82812 10.7188 3.125 10.0625 2.65625C8.98438 2 8 1.625 7.0625 1.625C5.32812 1.625 3.96875 2.14062 3.03125 3.07812C2.09375 4.01562 1.625 5.375 1.625 7.0625C1.625 8 1.90625 8.98438 2.46875 10.0156C2.9375 10.9531 3.59375 11.75 4.34375 12.4062L12.3594 20.3281C12.4531 20.4219 12.5469 20.4219 12.6406 20.3281L20.6094 12.4531Z"
                                fill="#666666"
                            />
                        </svg>
                    </NavbarLink>
