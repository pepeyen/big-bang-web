...
function AudioPlayer(props){
    ...
    return(
        <React.Fragment>
            <button 
                className={`player --thin-borders ${isAudioPlaying ? '--playing' : ''}`}
                type="button"
                ...
                >
                    {
                        isAudioPlaying ?
                            <React.Fragment>
                                <path d="M91.125 0H25.875C19.872 0 15 6.72 15 15V285C15 293.28 19.872 300 25.875 300H91.125C97.128 300 102 293.28 102 285V15C102 6.72 97.128 0 91.125 0Z" fill={isButtonBright ? '#73A8A0' : '#ffffff'}/> 
                                <path d="M274.125 0H208.875C202.872 0 198 6.72 198 15V285C198 293.28 202.872 300 208.875 300H274.125C280.128 300 285 293.28 285 285V15C285 6.72 280.128 0 274.125 0Z" fill={isButtonBright ? '#73A8A0' : '#ffffff'}/>
                            </React.Fragment> 
